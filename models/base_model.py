...
class BaseModel(ABC):
    ...
    To create a subclass, you need to implement the following five functions:
        ...
        -- <set_input>:                     unpack data from data and apply preprocessing.
        -- <forward>:                       produce intermediate results.
        -- <optimize_parameters>:           calculate losses, gradients, and update network weights.
        -- <modify_commandline_options>:    (optionally) add models-specific options and set default options.
    """
    ...
    def modify_commandline_options(parser, is_train):
        """Add new models-specific options, and rewrite default values for existing options.
